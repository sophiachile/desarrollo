...
<head>
  ...
  <link rel="stylesheet" href="{{asset('asset/dist/css/masterLogin.css')}}">  
    ...
    <nav class="navbar navbar-static-top">
      ...
      <div class="navbar-custom-menu" name="menu1">
        <ul class="nav navbar-nav">
          <form autocomplete="off" name="user_login" method="post" action="validar.php">
            <input id="user_mail" name="user_mail" type="email" placeholder=" Usuario (email)" value="">
            <input id="pass_inicio" name="pass_inicio" type="password" placeholder=" Password">
